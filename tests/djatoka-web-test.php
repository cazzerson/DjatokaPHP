...
print 'center, best level: <img src="' . $region->reset()->setClosestLevelToScale(500)->square('center')->url() . '"/>';
print 'top left: <img src="' . $region->reset()->scale(500)->square('center')->url() . '"/>';
print 'bottom right: <img src="' . $region->reset()->scale(500)->square('bottom_right')->url() . '"/>';
print '<br />';
